...
namespace Sort.NUnitTests
{
	...
	public class SortTests
	{
		...
		{
			Assert.Throws<ArgumentNullException>(() => BubleSort.BubleSort.Sort(null, new Comparers.ByAscendingMaxElements()));
			Assert.Throws<ArgumentNullException>(() => BubleSort.BubleSort.Sort(testArray, null));
		}
		...
		public void Sort_SortByAscendingSum_ValidResult()
		{
			...
			BubleSort.BubleSort.Sort(result, comparer);
